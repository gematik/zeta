# Wie Sie den Cluster lokal mit KIND aufsetzen
...
# Restricted Pod-Security-Standard aktivieren
...
# Output soll wie folgendes aussehen:
# NAME           STATUS   AGE   LABELS
# zeta-local   Active   83d   kubernetes.io/metadata.name=zeta-local
